...
class Agreement extends Component {
    ...
    render() {
        return (
            <div data-scroll-container id="policy">
                ...
                <div className="container-home">
                    ...
                    <div className="home-header" data-scroll-section>
                        <h1 className="mb-0 font-travels-black" data-scroll data-scroll-speed="1"
                            data-scroll-position="top">
                            <span className="d-block">НА ВСЯКИЙ</span>
                            <span>СЛУЧАЙ.</span>
                        </h1>
                    </div>
                </div>
                <div className="container-home" >
                    <div data-scroll-section>
                        <div  data-scroll data-scroll-speed="1" data-scroll-position="top">
                            <h3 className="font-travels-bold mt-48">Политика в отношении обработки персональных данных</h3>

                            <p className="font-travels-medium">1. Общие положения</p>
                            <p className="font-travels-medium">
                                Настоящая политика обработки персональных данных составлена в соответствии с требованиями
                                ЗРУ-547-сон 02.07.2019 «О персональных данных» (далее - Закон о персональных данных) и
                                определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных
                                данных, предпринимаемые АО "AsakaBank" (далее – Оператор).
                            </p>
                            <p className="font-travels-medium">
                            ...
                            <p className="font-travels-medium">
                                1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее – Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта <a href="https://hr.askabank.uz" target="_blank">https://hr.askabank.uz</a>.
                            </p>
                            <p className="font-travels-medium">
                            ...
                            <p className="font-travels-medium">
                                2.3. Веб-сайт – совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу <a href="https://hr.askabank.uz" target="_blank">https://hr.askabank.uz</a>.
                            ...
                            <p className="font-travels-medium">
                                ...
                                <a href="https://hr.askabank.uz" target="_blank">https://hr.askabank.uz</a>.
                            ...
                            <p className="font-travels-medium">
                                2.10. Пользователь – любой посетитель веб-сайта <a href="https://hr.askabank.uz" target="_blank">https://hr.askabank.uz</a>.
                            ...
                            <p className="font-travels-medium">
                                7.2. Также Оператор имеет право направлять Пользователю уведомления о новых продуктах и услугах, специальных предложениях и различных событиях. Пользователь всегда может отказаться от получения информационных сообщений, направив Оператору письмо на адрес электронной почты asakabankit@gmail.com с пометкой «Отказ от уведомлений о новых продуктах и услугах и специальных предложениях».
                            ...
                            <p className="font-travels-medium">
                                ...
                                – Закон Республики Узбекистан О персональных данных; <br/>
                                – законы, иные нормативно-правовые акты в сфере защиты персональных данных; <br/>
                                – согласия Пользователей на обработку их персональных данных, на обработку персональных данных, разрешенных для распространения.

                            </p>
                            <p className="font-travels-medium">
                                8.2. Оператор обрабатывает персональные данные Пользователя только в случае их заполнения и/или отправки Пользователем самостоятельно через специальные формы, расположенные на сайте <a href="https://hr.askabank.uz" target="_blank">https://hr.askabank.uz</a>. или направленные Оператору посредством электронной почты. Заполняя соответствующие формы и/или отправляя свои персональные данные Оператору, Пользователь выражает свое согласие с данной Политикой.
                            ...
                            <p className="font-travels-medium">
                                10.3. В случае выявления неточностей в персональных данных, Пользователь может актуализировать их самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора asakabankit@gmail.com с пометкой «Актуализация персональных данных».

                            </p>
                            <p className="font-travels-medium">
                                10.4. Срок обработки персональных данных определяется достижением целей, для которых были собраны персональные данные, если иной срок не предусмотрен договором или действующим законодательством.
                                Пользователь может в любой момент отозвать свое согласие на обработку персональных данных, направив Оператору уведомление посредством электронной почты на электронный адрес Оператора <a
                                href="mailto:asakabankit@gmail.com" target="_blank">asakabankit@gmail.com</a> с пометкой «Отзыв согласия на обработку персональных данных».
                            ...
                            <p className="font-travels-medium">
                                14.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты <a
                                href="mailto:asakabankit@gmail.com">asakabankit@gmail.com</a>.
                            ...
                            <p className="font-travels-medium">
                                14.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу https://hr.askabank.uz/privacy.

                            </p>
                            <div className="footer mt-48" >
                                <p className="info policy-info font-travels-demi-bold mt-64" >©2021. АО "AsakaBank". Твой банк. Твои люди. <br/>
                                    78 1476565 (IT отдел, внут. 1827) </p>
                                <p className="django policy-info font-travels-medium mt-3">
                                    * Django Unchained. A Band Apart. Columbia Pictures. Giphy.com <br/>
